...
## Switches
set_property PACKAGE_PIN V17 [get_ports {zx}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {zx}]
set_property PACKAGE_PIN V16 [get_ports {nx}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {nx}]
set_property PACKAGE_PIN W16 [get_ports {zy}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {zy}]
set_property PACKAGE_PIN W17 [get_ports {ny}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ny}]
set_property PACKAGE_PIN W15 [get_ports {f}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {f}]
set_property PACKAGE_PIN V15 [get_ports {no}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {no}]
set_property PACKAGE_PIN W14 [get_ports {address_a[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {address_a[0]}]
set_property PACKAGE_PIN W13 [get_ports {address_a[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {address_a[1]}]
set_property PACKAGE_PIN V2 [get_ports {address_a[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {address_a[2]}]
set_property PACKAGE_PIN T3 [get_ports {address_a[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {address_a[3]}]
set_property PACKAGE_PIN T2 [get_ports {address_a[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {address_a[4]}]
set_property PACKAGE_PIN R3 [get_ports {address_b[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {address_b[0]}]
set_property PACKAGE_PIN W2 [get_ports {address_b[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {address_b[1]}]
set_property PACKAGE_PIN U1 [get_ports {address_b[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {address_b[2]}]
set_property PACKAGE_PIN T1 [get_ports {address_b[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {address_b[3]}]
set_property PACKAGE_PIN R2 [get_ports {address_b[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {address_b[4]}]
...
##Buttons
#set_property PACKAGE_PIN U18 [get_ports BTN_addr]						
	#set_property IOSTANDARD LVCMOS33 [get_ports BTN_addr]
#set_property PACKAGE_PIN T18 [get_ports BTN_write]						
    #set_property IOSTANDARD LVCMOS33 [get_ports BTN_write]
#set_property PACKAGE_PIN W19 [get_ports initialise]						
	#set_property IOSTANDARD LVCMOS33 [get_ports initialise]
